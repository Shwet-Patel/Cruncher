...
function App() {
  ...
  return (
    ...
    <div className="bg-dimblue min-h-screen py-16">
      {/* card */}
      <div className="min-h-full bg-darkcream grid grid-cols-[20%,80%] mx-auto max-w-6xl shadow-xl rounded-lg">
        ...
        <div className="flex flex-col justify-between">
          ...
          {/* Quote */}
          <div className="text-darkblue opacity-85 bg-neutral-200 italic font-normal font-sans rounded-b-md p-4 mt-auto">
